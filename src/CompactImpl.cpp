...
ICompact *ICompact::createIntersection(ICompact const *op1, ICompact const *op2, IMultiIndex const *const grid,
    ...
    auto intersectionPossible = [](double left_data1, double right_data1, double left_data2, double right_data2,
                                   double &res_left, double &res_right) -> bool {
        if (right_data1 < left_data2 || right_data2 < left_data1) {
            res_left = 0;
            res_right = 0;
            return false;
        } else if (left_data2 < left_data1 && right_data1 < right_data2) {
            res_left = left_data1;
            res_right = right_data1;
            return true;
        } else if (left_data1 < left_data2 && right_data2 < right_data1) {
            res_left = left_data2;
            res_right = right_data2;
            return true;
        } else if (left_data1 < left_data2 && left_data2 < right_data1 && right_data1 < right_data2) {
            res_left = left_data2;
            res_right = right_data1;
            return true;
        } else if (left_data2 < left_data1 && left_data1 < right_data2 && right_data2 < right_data1) {
            res_left = left_data1;
            res_right = right_data2;
            return true;
        } else
